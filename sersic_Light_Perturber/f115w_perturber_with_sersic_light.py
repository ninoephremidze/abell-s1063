...
file_path = "/n/home02/nephremidze/cab_survey/abell-s1063/f115w/data/"
...
maxnfw = [10000.,500.,xpp+0.75,ypp+0.08]
minnfw = [0.,1.,xpp+0.62,ypp-0.10]
...
labls_mask = ["$M_{200} / 10^7 M_{\odot}$", '$c_{200}$', "$x_p$ ['']", "$y_p$ ['']", "I_0", "$R_{sers}$", "$n$"]
