...
def model_curved_fit_shapelet_sers(data,kappashear_params,source_params,likemask_list,indices):   
    ...
    # the lens model is a supperposition of an elliptical lens model with external shear
        lens_model_list_new = ['SHIFT','CURVED_ARC_SPT']
...
maxlens3 = [2.,7.,0.5,0.4]
minlens3 = [0.05,1.,-0.6,0.1]
...
maxgamma1s = [0.5, 1.0, 0.5]
mingamma1s = [-0.5, -0.5, -0.5]

maxgamma2s = [0.5, 0.5, 0.5]
mingamma2s = [-0.5, -0.5, -0.5]

maxparam = maxlens1 + maxlens2 + maxshift + maxlens3 + maxshift + maxshape + maxgamma1s + maxgamma2s
minparam = minlens1 + minlens2 + minshift + minlens3 + minshift + minshape + mingamma1s + mingamma2s
...
def lnlike(params):      
    ...
    kwargs_kapshe = [[{'alpha_x':0.,'alpha_y':0.},
                      {'tangential_stretch': mut1, 'radial_stretch': mur1, 'curvature': cv1, 'gamma1': gamma1s_1, 'gamma2': gamma2s_1, 'direction': psi_ext1, 
                       'center_x': 0., 'center_y': 0.}],
                     [{'alpha_x':0.,'alpha_y':0.},
                      {'tangential_stretch': mut2, 'radial_stretch': mur2, 'curvature': cv2, 'gamma1': gamma1s_2, 'gamma2': gamma2s_2, 'direction': psi_ext2, 
                       'center_x': params[7], 'center_y': params[8]}],
                     [{'alpha_x':0.,'alpha_y':0.},
                      {'tangential_stretch': mut3, 'radial_stretch': mur3, 'curvature': cv3, 'gamma1': gamma1s_3, 'gamma2': gamma2s_3, 'direction': psi_ext3, 
...
labls_mask = ['$\\lambda_{\mathrm{tan},1}$','$s_{\mathrm{tan},1}$ [arcsec$^{-1}$]','$\\phi_{1}/\pi$ ',
             ...
             '$\\gamma1_1$', '$\\gamma2_1$', '$\\gamma1_2$', '$\\gamma2_2$', '$\\gamma1_3$', '$\\gamma2_3$']
