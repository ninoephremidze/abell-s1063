...
file_path = "/n/home02/nephremidze/spring/4-May/abell-s1063-cab/data/f200w/"

array200sci = np.load(file_path+'f200w_image1_.npy')
array200err = np.load(file_path+'f200w_error1_.npy')

array200sci2 = np.load(file_path+'f200w_image2_.npy')
array200err2 = np.load(file_path+'f200w_error2_.npy')

array200sci3 = np.load(file_path+'f200w_image3_.npy')
array200err3 = np.load(file_path+'f200w_error3_.npy')
...
kernel_cut = np.load("/n/home02/nephremidze/cab_survey/abell-s1063/psf_calculation/jwst_psf_200_sim.npy")
